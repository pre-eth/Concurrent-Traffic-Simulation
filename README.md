...
* OpenCV >= 4.1
  * Fedora: `sudo dnf install opencv opencv-devel`
  * Other: The OpenCV 4.1.0 source code can be found [here](https://github.com/opencv/opencv/tree/4.1.0)
* gcc/g++ >= 5.4
...
These are the tasks I had to complete.
